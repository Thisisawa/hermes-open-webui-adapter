...
- `05:46:12 → 05:46:27`：prompt_tokens 從 **18,301 → 21,240**（tool loop 期間 +2,939 tokens）
- `05:46:45`（tool loop 結束後的新訊息）：prompt_tokens 掉回 **18,698**——只比原始多 +397 tokens
- **預期**：如果工具結果正確包含，應該有 ~21,240+ tokens
- **實際**：18,698——工具結果**根本不在**對話歷史中
...
> **注意**：metrics_proxy 不在資料路徑中——它監控獨立的 vLLM 端口。
